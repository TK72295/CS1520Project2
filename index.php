...
<body>
    ...
    $('input[type="submit"]').on('click', function(e){
        ...
        if(myText != ''){
            $.post("submitQuestion.php", {myText: myText}, function(data){
                    if(data == '1'){
                        $('#contact p').append('<p>Thank you for your input!</p>');
                    }
                    else{
                        $('#contact p').append("<p>Sorry, we're having trouble processing that request</p>");
                    }
             });
        }
        else{
